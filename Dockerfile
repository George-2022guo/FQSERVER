...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/George-2022guo/FQSERVER/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'You can play the awesome Cloud NOW! - Message from George Guo!' >/var/www/html/index.html
